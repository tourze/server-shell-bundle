...
/**
 * @extends AbstractCrudController<ShellScript>
 */
#[AdminCrud(routePath: '/server-shell/shell-script', routeName: 'server_shell_shell_script')]
final class ShellScriptCrudController extends AbstractCrudController
{
